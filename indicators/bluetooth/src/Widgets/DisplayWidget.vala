...
public class BluetoothIndicator.Widgets.DisplayWidget : Gtk.Spinner {
    ...
    private const string TOOLTIP_SECONDARY_TEXT_MARKUP = """<span weight="600" size="smaller" alpha="75%">%s</span>""";
    ...
    construct {
        ...
        provider.load_from_resource ("com/github/hcsubser/hybridbar/bluetooth/indicator.css");
    ...
    private void update_icon () {
        ...
        tooltip_markup = "%s\n%s".printf (
            description, TOOLTIP_SECONDARY_TEXT_MARKUP.printf (context)
        );
    }
}
